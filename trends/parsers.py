...
class CoordinateParser:
    ...
    @staticmethod
    def calculate_centers(coordinates: List[Tuple[int, int, int, int]]) -> List[Tuple[int, int]]:
        ...
        for idx, (x1, y1, x2, y2) in enumerate(coordinates):
            ...
            print(f"  Image {idx+1}: Rectangle [{x1},{y1},{x2},{y2}] -> Center ({center_x},{center_y})")
...
class ResponseParser:
    ...
    @staticmethod
    def extract_coordinates_from_message(message_text: str) -> Optional[Tuple[int, int]]:
