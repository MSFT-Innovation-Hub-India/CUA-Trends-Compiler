...
class LocalPlaywrightComputer:
        ...
        try:
            ...
            def handle_console_message(msg):
                if msg.type == "error":
                    ...
                    if any(filter_term in error_text for filter_term in [
    ...
    async def goto(self, url):
        ...
        try:
            response = await self._page.goto(url, wait_until="networkidle", timeout=60000)
